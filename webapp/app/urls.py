...
urlpatterns = [
    ...
    path("view_filtered_ionograms", views.view_filtered_ionograms, name='view_filtered_ionograms'),
    path("filter-ionograms/<int:id>", views.filter_ionograms, name='ionograms_filter'),
